<%@ Page Title="All Active Registered Candidate" Language="C#" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" Inherits="EnableIndia.ReportSection.AllActiveRegisteredCandidateReport" Codebehind="AllActiveRegisteredCandidateReport.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table>
        <tr>
            ...
            <td><asp:TextBox ID="TxtDateOfBirth" runat="server" yearlength="4"></asp:TextBox></td>
        </tr>
    </table>
...
--%>
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtRegistrationFrom" runat="server" yearlength="4"></asp:TextBox><br />
                  (dd/mm/yyyy)
...
--%>
            ...
            <td><label for="ctl00_ContentPlaceHolder2_TxtRegistrationFrom" class="skiplink">Registration Date from</label></td>
            <td><label for="ctl00_ContentPlaceHolder2_TxtRegistrationTo">To</label></td>
             <td>
                <asp:TextBox ID="TxtRegistrationTo" runat="server" yearlength="4"></asp:TextBox><br />
                (dd/mm/yyyy)
...
--%>            </td>
    ...
    <table>
        <tr>
            <td style="width:160px">Employment Project through which candidate got job:</td>
            <td>Start Date</td>
            <td>From</td>
            <td>
                <asp:TextBox ID="TxtEmployementProjectStartDateFrom" runat="server" yearlength="4"></asp:TextBox><br />
                  (dd/mm/yyyy)
...
--%>            </td>
            <td><label for="ctl00_ContentPlaceHolder2_TxtEmployementProjectStartDateFrom" class="skiplink">Start Date from</label></td>
            <td>
                <label for="ctl00_ContentPlaceHolder2_TxtEmployementProjectStartDateTo">To</label>
            </td>
             <td>
                <asp:TextBox ID="TxtEmployementProjectStartDateTo" runat="server" yearlength="4"></asp:TextBox><br />
                (dd/mm/yyyy)
...
--%>            </td>
            ...
            <td style="width:135px;">End Date</td>
            <td>From</td>
            <td>
                <asp:TextBox ID="TxtEmploymentEndDateFrom" runat="server" yearlength="4"></asp:TextBox><br />
                  (dd/mm/yyyy)
...
--%>            </td>
            <td> <label for="ctl00_ContentPlaceHolder2_TxtEmploymentEndDateFrom" class="skiplink">End Date from</label></td>
             <td>
                <label for="ctl00_ContentPlaceHolder2_TxtEmploymentEndDateTo">To</label>
            </td>
            <td>
                <asp:TextBox ID="TxtEmploymentEndDateTo" runat="server" yearlength="4"></asp:TextBox><br />
                  (dd/mm/yyyy)
...
--%>            </td>
    ...
    <table>
        <tr>
         ...
         <asp:UpdateProgress runat="server" id="UpdateProgress2" AssociatedUpdatePanelID="PleaseWaitPanel" DynamicLayout="false">
           <ProgressTemplate>
               <div class="posCentre">
               <table width="500px" style="height:100px; border-bottom-color:Blue; border-bottom-style: solid; border-top-color: Blue; border-top-style: solid; border-width:1; background-color:#91a8fe;">
                 <tr>
                ...
                <tr>
                   <td valign="middle" align="center" style="width:500px;">
                     <asp:Label runat="server" ID="lbWaitState" Text="-: Please Wait - Program Creation under progress : -" Font-Bold="true" Font-Size="10" ForeColor="#D32232"></asp:Label>
                   </td>
               </tr>
               </table>
            </div>
    ...
    <table>
        <tr>
            ...
            <td><a id="LnkGenrateDetail" style="display:none" href="RegistrationDetaiFromSearch.aspx" target="_blank"  ></a>
                        <asp:Button ID="BtnGenrateCandidateDetail" runat="server" Text="Go" ClientIDMode="Static"  OnClientClick="javascript: GoRegistrationDetail();"  />
             </td>
        </tr>
    </table>
    <table>
        <tr>
            <td>
               <div id="stisdiv" runat="server">
                <cc1:StiWebViewer ID="StiWebViewer1" runat="server" RenderMode="AjaxWithCache"  ViewMode="WholeReport"
                     Height="100%" />
               </div>
            </td>
        </tr>
    </table>
    <div id="divforScript" runat="server">
              <script language="javascript" type="text/javascript">
                  function adjustDivs() {
                      var df = document.getElementById('<%=UpdateProgress2.ClientID %>');
                      df.style.position = 'absolute';
                      //                   df.style.left = (document.documentElement.scrollLeft+50) + '%';
                      df.style.left = (document.body.offsetWidth / 2) - 150;
                      df.style.top = (document.body.offsetHeight / 2) - 100;
                  ...
                  function appl_init() {
                      ...
                      prm.add_beginRequest(startRequest);
                  ...
                  function instance_initializeRequest(sender, args) {
                      if (args.get_postBackElement().id == 'btnRefresh') {
