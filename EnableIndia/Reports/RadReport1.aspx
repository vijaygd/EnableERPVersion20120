<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RadReport.aspx.cs" Inherits="EnableIndia.Reports.RadReport" %>
    ...
    <table width="99%" cellpadding="0" cellspacing="0">
       <tr>
          <td valign="middle" align="left" style="border-bottom: 1px solid blue; border-top: 1px solid blue; width:50%;">
              <asp:Label runat="server" ID="lbHeader" Font-Bold="true" Font-Size="14"></asp:Label>
          </td>
          <td valign="middle" align="right" style="border-bottom: 1px solid blue; border-top: 1px solid blue; width:50%;">
              <asp:Button runat="server" ID="btnClose" OnClick="btnCloseClicked" Text="C l o s e" Font-Bold="true" Font-Size="8.5" Font-Names="Consolas" CssClass="buttonRounded" />
          </td>
       </tr>
    </table>
     <telerik:ReportViewer runat="server" ID="radReport"  Width="99%" Height="100%" style="background-color:transparent;"  >
