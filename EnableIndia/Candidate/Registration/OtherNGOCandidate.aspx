<%@ Page Language="C#" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" Inherits="EnableIndia.Candidate.Registration.OtherNGOCandidate" Title="Other NGO Candidate Registration" Codebehind="OtherNGOCandidate.aspx.cs" ClientIDMode="Static" %>
        ...
        <td>
            ...
            <table>
                <tr>
                    <td style="width:185px">
                        ...
                        <asp:Label CssClass="labelStyle" runat="server" ID="lbDdlNgos" for="ctl00_ContentPlaceHolder2_DdlNgos" Text="NGO" AssociatedControlID="DdlNgos"></asp:label>
                    </td>
                    <td>
            ...
            <table style="margin-bottom:5px">
                <tr>
                   ...
                   <asp:ImageButton runat="server" ID="Image2" AlternateText="RegD" ImageAlign="AbsMiddle" ImageUrl="~/Image/calendar.gif" ClientIDMode="Static" />
                    <cc1:CalendarExtender runat="server" ID="CalendarExtender2" PopupButtonID="Image2" TargetControlID="TxtRegistrationDate" Format="dd/MM/yyyy" ClientIDMode="Static"></cc1:CalendarExtender>
                    <br />(DD/MM/YYYY)
                      <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="TxtRegistrationDate"
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td valign="middle"  style="padding-left:30px;">
                                    <label for="ctl00_ContentPlaceHolder2_TxtCandidateMiddleName">Middle Name</label>
                                     <asp:Label CssClass="labelStyle" runat="server" ID="Label21" Text="&nbsp;"  Font-Bold="true" Font-Size="12" ></asp:Label>
                                    <br />
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="TxtDateOfBirth"
                        ValidationGroup="Reg" hilite="txtOMdate" ErrorMessage="Please Enter Valid Date(DD/MM/YYYY)"
                        runat="server" Display="Dynamic" ValidationExpression="[0-3][0-9]/[0-1][0-9]/[1-2][0-9][0-9][0-9]" />
                    </td>
                    <td>(DD/MM/YYYY)</td>
            ...
            <table type="table" class="mandatory" messagetext="gender">
                <tr>
                    ...
                    <asp:Label CssClass="labelStyle" runat="server" ID="lbGenderT" Text="GENDER"></asp:Label>
                    </td>
                    <td valign="middle">
            ...
            <table  >
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td valign="middle" align="left" style="width:185px">
...
--%>                                                </td>
                        ...
                        <table cellspacing="0">
                            <tr>
                                ...
                                <asp:Label CssClass="labelStyle" runat="server" ID="lbDdlPermanentAddressCities" for="ctl00_ContentPlaceHolder2_DdlPermanentAddressCities" Text="CITY" AssociatedControlID="DdlPermanentAddressCities"></asp:Label>
                                    <asp:Label CssClass="labelStyle" runat="server" ID="Label19" Text="* " ForeColor="#D32232" Font-Bold="true" Font-Size="12"></asp:Label>
                                   <br />
                                ...
                                <td style="padding-left:15px">
                                    <asp:Label CssClass="labelStyle" runat="server" ID="Label20" Text="* " ForeColor="#D32232" Font-Bold="true" Font-Size="12"></asp:Label>
            ...
            <table>
                <tr>
                    ...
                    <td><asp:TextBox ID="TxtEmailAddress" runat="server" Width="350px" type="emailaddress" /></td>
                </tr>
            </table>
                    ...
                    <td>
                        ...
                        <table>    
                            <tr>
                                ...
                                <td>
                                    <asp:FileUpload ID="FuUploadPhoto" runat="server" class="mandatory" ClientIDMode="Static" />
                                </td>
                            </tr>
                        </table>
                        ...
                        <table style="margin-bottom:15px">
                            <tr>
                                <td  align="center" style="border-style:double;border-width:2px;border-color:#4C77A4;width:105px;height:112px">
                                      <asp:Image ID="ImgCandidatePhoto" runat="server" AlternateText="candidate-photo" ClientIDMode="Static" />
                                </td>
                            </tr>
                        </table>
                        <table>
...
<div runat="server" id="fup">
  <script type="text/javascript" language="javascript">
      function fupClicked(fup) {
          var fid = fup;
          // var tdPhoto = document.getElementById("ImgCandidatePhoto");
          var tdPhoto = document.getElementById("ImgCandidatePhoto");
          //setAttribute('src', 'http://ecx.images-amazon.com/images/I/41%2BjAZ4dUGL._SS500_.jpg');
          if (fup.value != null) {
              var path = replaceAll("\\", "/", fup.value);
              path = "file:///" + path;
              path = path.replace("\"", "");
              path = path.replace("\"", "");
              tdPhoto.setAttribute("src", "'" + path + "'");
    //          tdPhoto.src = path;
