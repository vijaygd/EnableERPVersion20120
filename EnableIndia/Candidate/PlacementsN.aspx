<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlacementsN.aspx.cs" Inherits="EnableIndia.PlacementsN" %>
...
<body>
    <center>
    <form id="forPlacements" runat="server">
       ...
       <table cellpadding="2" cellspacing="0"  style="width:1024px;">
           <tr>
              <td valign="middle" align="left" style="width:25%;" >
                  <asp:Label runat="server" ID="lbgbt" Text="Candidates Placed" Font-Bold="true" Font-Size="14pt"></asp:Label>
              </td>
             ...
             <BDP:IsDateValidator runat="server" ID="IsDateValidator1" Display="Dynamic" ErrorMessage="Please Enter Valid Date" ControlToValidate="dtEndDate"></BDP:IsDateValidator>
              ...
              <td valign="middle" align="left" style="width:25%;">
                 ...
                 onclick="btnReset_Click" ToolTip="Reset to original status"  />&nbsp;
                         <asp:ImageButton runat="server" ID="ImageButton1" ImageUrl="~/Image/Close.gif"  AlternateText="Close" ImageAlign="AbsMiddle" Height="30"  Width="70px"
