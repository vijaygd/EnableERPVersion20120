    ...
    public partial class candidateRegistration : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (lbh != null)
                {
                    lbh.Text = "Candidate Registration";
                }
        ...
        protected void BtnRegisterCandidate_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["cand"] != null)
            {
                ...
                if (isUpdated.Equals(true))
                {
                    ...
                    url += "&msg=" + "Candidate registered successfully.";
                    url += "&foc=" + "null";
                    ...
                    Response.Redirect("~/MobileDevices/mdDefaultPage.aspx" + url, false);
                }
                else
                {
            ...
            else
            {
                ...
                {
                    string url = "~/MobileDevices/mdDefaultPage.aspx?msg=" + Global.EncryptID(cand.CandidateID);
                    //url += "&msg=" + Global.EncryptQueryString("Candidate registered successfully with ID of: " + cand.CandidateID.ToString());
                    //url += "&foc=" + Global.EncryptQueryString("null");
                    url += "&msg=" + "Candidate registered successfully with ID of: " + cand.CandidateID.ToString();
                    url += "&foc=" + "null";
