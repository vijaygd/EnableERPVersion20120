...
{
    public partial class mdEducationalQualification : System.Web.UI.Page
    {
        string[,] eduArray;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (lbh != null)
                {
                    lbh.Text = "Educational Qualifications";
                }
        ...
        protected void LnkBtnCourseQualificationName_Click(object sender, EventArgs e)
        {
            ...
            int fEqual = orgUrl.IndexOf((char)'=');
            string candId = orgUrl.Substring(fEqual + 1, (orgUrl.Length - (fEqual + 1)));
            string url = "~/Candidate/EducationalQualificationsPopUp.aspx?cand=" + candId + "&cand_qual=" + CourseQualId;
            popEduArray();
            invokeRadWindow(url);
