<%@ Page Title="Add Recommended Candidate" Language="C#" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" Inherits="EnableIndia.Company.AddRecommendedCandidate" Codebehind="AddRecommendedCandidate.aspx.cs" ClientIDMode="Static" %>
...
<table cellpadding="0" cellspacing="0"  class="pageHeaderLevel1">
    <tr>    
        <td>Manage Open Employment Projects>Step 1: Add Recommended Candidates</td>
    </tr>
</table>
...
--%>    
        ...
        <td>
          ...
          <%--  <asp:LinkButton ID="LnkBtnEmploymentProjectDetails" runat="server" Text="Employment Project Details & Contacts" 
                PostBackUrl="~/Company/AddEmploymentProjects.aspx" CssClass="tab_links" />--%>
        </td>
    </tr>
</table>
...
<table>
    <tr>
        <td style="width:300px;padding-left:12px">
              <asp:LinkButton ID="LnkBtnAddNonRecommendedCandidates" runat="server" Text="Step 2: Add Non-Recommended Candidates" OnClick="LnkBtnAddNonRecommendedCandidates_Click" 
                CssClass="tab_links" />
        </td>
...
<script type="text/javascript" src="AddRecommendedCandidate.js"></script>

<table cellpadding="0" cellspacing="0" class="skiplink">
    <tr>
        <td>
            <h1><span id="skipToTop" class="skiplink" style="color:White">Add Recommended Candidates</span></h1>
        </td>
    </tr>
</table>
...
<table>
    <tr>
        ...
        <td>
            <asp:Button ID="BtnSearchRecommendedCandidates" runat="server" 
                OnClientClick="javascript:$.cookie('grid_page_number',1,{path: '/'});"
                Text="Go" OnClick="BtnSearchRecommendedCandidates_Click" />
...
<table>
    <tr>
        <td>
            <asp:ListView ID="LstViewRecommendedCandidate" runat="server" OnItemDataBound="LstViewRecommendedCandidate_ItemDataBound">
                <LayoutTemplate>
                    <table style="margin-bottom:10px">
                        <tr>
                            <td style="font-weight:bold;width:400px">
                                <u>Recommended Candidates for this Employment Project</u>
                            </td>
                            <td>
                    ...
                    <table id="TblRecommendedCandidates" cellpadding="4" class="tableBorder" cellspacing="0" rules="all"
                ...
                <ItemTemplate>
                    <tr>
                       <td id="TdRadioButton" >
                           <asp:CheckBox ID="ChkRecommendedCandidate" runat="server" 
                       ...
                       <td align ="left" style="width:150px" title="<%#Eval("candidate_name") %>'s Email"><%#Eval("email_address")%></td>
                       ...
                       <td align="left" title="<%#Eval("candidate_name") %>'s RecommendedJobType"><%#Eval("recommended_job_types")%></td>
