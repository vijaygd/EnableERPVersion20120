...
$(document).ready(function() {
    ...
    ShowPopUp("../ITextPopup.aspx?page=TrainingProjects", 800, 150);
});
...
function GoSearchParameter()
{
    ...
    var registrationDateFrom=$("#ctl00_ContentPlaceHolder2_TxtFromDate").val();
    ...
    var registrationToDate=$("#ctl00_ContentPlaceHolder2_TxtToDate").val();
