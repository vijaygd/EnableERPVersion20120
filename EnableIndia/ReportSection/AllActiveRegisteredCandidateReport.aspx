<%@ Page Title="All Active Registered Candidate" Language="C#" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" Inherits="EnableIndia.ReportSection.AllActiveRegisteredCandidateReport" Codebehind="AllActiveRegisteredCandidateReport.aspx.cs" ClientIDMode="Static" %>
     ...
     <table>
        <tr>
            ...
            <td align="left" valign="middle" style="height: 35px;">
                <asp:Label CssClass="labelStyle" runat="server" ID="lbContExpDateT" Text="Cont Expiry Date: " AssociatedControlID="ddContExpDate"></asp:Label>
                <asp:DropDownList runat="server" ID="ddContExpDate">
                    <asp:ListItem Text="All" Value="-1"></asp:ListItem>
                    <asp:ListItem Text="With Dates only" Value="0"></asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
     </table>
