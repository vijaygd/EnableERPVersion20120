<%@ Page Title="Ownerwise Closed Candidate Work Distribution" Language="C#" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" Inherits="EnableIndia.ReportSection.OwnerWiseClosedCandidateTask" Codebehind="OwnerWiseClosedCandidateTask.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table cellpadding="0" cellspacing="0"  class="pageHeaderLevel1">
        <tr>
            <td>Ownerwise Closed Candidate Work Distribution</td>
        </tr>
    </table>
</asp:Content>
