...
// using Stimulsoft.Report.Dictionary.StiMySqlDatabase;

namespace EnableIndia.ReportSection
{
    public partial class GotJob : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsPostBack)
            {
                ...
                if (ViewState["bFts"] != null)
                {
                    bFts = (bool)ViewState["bFts"];
                }
            }
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //report.RegData("DataSource1", myDt);
                // report.Load(Server.MapPath("~/Reports/Test2.mrt"));
             }
            catch (System.Exception ex)
            {
                this.lbStatus.Text = "Error: " + ex.Message;
            }
        }
        public MySqlConnection SetLocalConnection()
        {
            ...
            // connString = System.Configuration.ConfigurationManager.AppSettings["EnableIndiaConnectionString"];
        ...
        private void refreshReport()
        {
            ...
            report.Load(Server.MapPath("~/Reports/candGotJobPlacement.mrt"));
            report.RegData("DataSource1", myDt);
            report.Dictionary.Variables["repHeader"].ValueObject = "Candidates Got Job " + this.dtStartDate.SelectedDate.ToString("dd-MM-yyyy") + " to " + this.dtEndDate.SelectedDate.ToString("dd-MM-yyyy");
            StiWebViewer1.Report = report;
            this.lbNoRec.Text = myDt.Rows.Count.ToString();
            if (!bFts)
            {
