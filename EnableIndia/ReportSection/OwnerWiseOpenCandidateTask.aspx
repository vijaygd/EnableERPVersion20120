<%@ Page Title="Ownerwise Open Candidate Work Distribution" Language="C#" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" Inherits="EnableIndia.ReportSection.OwnerWiseOpenCandidateTask" Codebehind="OwnerWiseOpenCandidateTask.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table cellpadding="0" cellspacing="0"  class="pageHeaderLevel1">
        <tr>
            <td>Ownerwise Open Candidate Work Distribution</td>
        </tr>
    </table>
</asp:Content>
...
<table>
        <tr>
           <%-- <td>Select Date:</td>
            ...
            <td ><label for="ctl00_ContentPlaceHolder2_TxtFromDate">From Date :</label> </td>
            <td>
