<%@ Page Title="Training Programs Report" Language="C#" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" Inherits="EnableIndia.ReportSection.TrainingPrograms" Codebehind="TrainingPrograms.aspx.cs" ClientIDMode="Static" %>
...
<table cellpadding="0" cellspacing="0" class="skiplink">
    <tr>
        <td>
            <h1><span id="skipToTop" class="skiplink">Training Programs</span></h1>
        </td>
    </tr>
</table>
<table>
    ...
    <script src="TrainingPrograms.js" type="text/javascript"></script>
