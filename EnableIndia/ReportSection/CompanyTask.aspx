<%@ Page Title="Company Task" Language="C#" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" Inherits="EnableIndia.ReportSection.CompanyTask" Codebehind="CompanyTask.aspx.cs" ClientIDMode="Static" %>
...
<table cellpadding="0" cellspacing="0" class="skiplink">
    <tr>
        <td>
            <h1><span id="skipToTop" class="skiplink">Company Tasks</span></h1>
        </td>
    </tr>
</table>
    <table>
        <tr>
            <td style="width:100px">Task Type :</td>
            <td>
      ...
      <table>
       ...
       <table>
        <tr>
            <td style="width:70px">Select Date:</td>
            ...
            <td>
                ...
                runat="server" Display="Dynamic" ValidationExpression="[0-3][0-9]/[0-1][0-9]/[1-2][0-9][0-9][0-9]" /><br />
                  (dd/mm/yyyy)
<%--                 <cc1:MaskedEditValidator runat="server" ID="tbepfv" ControlExtender="tbepfe" ControlToValidate="TxtFromDate" ValidationExpression="^\d{2}/\d{2}/\d{4}$"></cc1:MaskedEditValidator>
                <cc1:MaskedEditExtender  runat="server" ID="tbepfe" TargetControlID="TxtFromDate" ClearMaskOnLostFocus="True" Enabled="True" Mask="99/99/9999" MaskType="Date" ></cc1:MaskedEditExtender>
--%>
            </td>
            ...
            <td>
                ...
                runat="server" Display="Dynamic" ValidationExpression="[0-3][0-9]/[0-1][0-9]/[1-2][0-9][0-9][0-9]" /><br />
                  (dd/mm/yyyy)
<%--               <cc1:MaskedEditValidator runat="server" ID="ttfdv" ControlExtender="ttfde" ControlToValidate="TxtToDate" ValidationExpression="^\d{2}/\d{2}/\d{4}$"></cc1:MaskedEditValidator>
                <cc1:MaskedEditExtender  runat="server" ID="ttfde" TargetControlID="TxtToDate" ClearMaskOnLostFocus="True" Enabled="True" Mask="99/99/9999" MaskType="Date" ></cc1:MaskedEditExtender>
--%>            </td>
        </tr>
      </table>
       <table>
                <tr>
                    <td style="width:103px">Search For</td>
                    <td>
        ...
        <tr>
            <td>
               <%-- <cc1:StiWebViewer ID="StiWebViewer1" runat="server" RenderMode="UseCache" ViewMode="WholeReport"
                    Height="800px" Width="1100px" ScrollBarsMode="true" />--%>
                     <cc1:StiWebViewer ID="StiWebViewer1" runat="server"  RenderMode="UseCache" ViewMode="WholeReport"
                     Height="100%" />
            </td>
        </tr>
    ...
    <script src="CompanyTask.js" type="text/javascript"></script>
</asp:Content>
