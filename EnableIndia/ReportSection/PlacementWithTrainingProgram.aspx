<%@ Page Title="" Language="C#" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" CodeBehind="PlacementWithTrainingProgram.aspx.cs" Inherits="EnableIndia.ReportSection.PlacementWithTrainingProgram" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
       <table cellpadding="2" cellspacing="0"  style="width:1024px;">
           <tr>
              <td valign="middle" align="left" style="width:20%;" >
             ...
             <BDP:IsDateValidator runat="server" ID="IsDateValidator1" Display="Dynamic" ErrorMessage="Please Enter Valid Date" ControlToValidate="dtEndDate"></BDP:IsDateValidator>
              ...
              <td valign="middle" align="left" style="width:40%;">
                 ...
                 onclick="btnChart_Click" ToolTip="Print Chart"  />&nbsp;
                        <asp:ImageButton runat="server" ID="ImageButton2" ImageUrl="~/Image/Print.gif"  AlternateText="Chart" ImageAlign="AbsMiddle" Height="16"  Width="16px"
                 onclick="btnPrint_Click" ToolTip="Print In Full Page"  />&nbsp;
                        <asp:ImageButton runat="server" ID="ImageButton3" ImageUrl="~/App_Themes/Default/images/ExportToExcel.gif"  AlternateText="Chart" ImageAlign="AbsMiddle" Height="16px"  Width="16px"
                 onclick="btnExportToExcel_Click" ToolTip="Export to excel"  />&nbsp;
              </td>
            </tr>
          </table>
       <table cellpadding="2" cellspacing="0" style="width:1024px;">
