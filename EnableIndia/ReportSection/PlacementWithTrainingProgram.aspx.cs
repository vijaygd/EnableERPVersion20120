...
{
    public partial class PlacementWithTrainingProgram : System.Web.UI.Page
    {
        ...
        public string s1 = "select cand_other_detl.candidate_name_with_status as candidate_name,cand.registration_id,cand.candidate_id,disability.disability_type,  " + 
         ...
         "mark_deleted=0    and is_entered_from_employment_project=1 ) as cand_work_expr  " +  
         "                "   +  
         ...
         " left join training_programs on training_projects.training_program_id =  training_programs.training_program_id "+
         " left join employees emp on  training_projects.employee_id=emp.employee_id  "+
        ...
        public string s2;
        public string s3 = "group by cand_work_expr.candidate_work_experience_id  order by cand.first_name";
        ...
        {
            rptPlacementsWithTrainingPrograms rgj = new rptPlacementsWithTrainingPrograms();
        ...
        protected void btnChart_Click(object sender, ImageClickEventArgs e)
        {
            ...
            chartPage = u1.Replace("/ReportSection/PlacementWithTrainingProgram.aspx", "/Reports/rptJobPlaceCharts.aspx");
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            string fmgurl = u1.Replace("ReportSection/PlacementWithTrainingProgram", "Reports/RadReport");
            fmgurl += "?Report=PlacementWithTrainingProgram&rptHeader=" + "Report Got Job from : " + this.dtStartDate.SelectedDate.ToString("dd-MM-yyyy") + " to " + this.dtEndDate.SelectedDate.ToString("dd-MM-yyyy");
        ...
        protected void btnExportToExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                xlDocBody.Append("<td valign=\"middle\" align=\"center\" style=\"width:50px;background-color:#EFE6FA;\" border=\"1\">" + "Empl Proof Received" + "</td>");
