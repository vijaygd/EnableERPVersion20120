<%@ Page Title="" Language="C#" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" CodeBehind="GotJobWithPlacements.aspx.cs" Inherits="EnableIndia.ReportSection.GotJobWithPlacements" %>
 ...
 <table cellpadding="0" cellspacing="0">
    ...
    <div>
       <table cellpadding="2" cellspacing="1">
           <tr>
              <td valign="middle" align="left" style="width:25%;" >
                  <asp:Label CssClass="labelStyle" runat="server" ID="lbgbt" Text="Candidates Got Job with training programs" Font-Bold="true" Font-Size="12pt"></asp:Label>
              </td>
           ...
           <tr>
              ...
              <td valign="middle" align="left" style="width:25%;">
                 ...
                 onclick="btnPrint_Click"  ToolTip="Print in full page" />&nbsp;
                         <asp:ImageButton runat="server" ID="ImageButton2" ImageUrl="~/App_Themes/Default/images/ExportToExcel.gif"  AlternateText="Chart" ImageAlign="AbsMiddle" Height="20"  Width="20px"
                 onclick="btnExport_Click"  ToolTip="Export to excel in single line format" />&nbsp;
      ...
      <div style="width:100%; height:580px;border-bottom-color:Blue; border-bottom-style:solid; border-width:1; border-top-color:Blue; border-top-style:solid;">
        <telerik:ReportViewer ID="tRadReport" Width="100%" Height="100%" runat="server" ToolbarVisible="true" ShowPrintButton="true" ShowNavigationGroup="true" ShowHistoryButtons="true"></telerik:ReportViewer>
     </div>

</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
   <div style="height:800px; width:100%;">
              <telerik:RadWindowManager runat="server" ID="radManager" DestroyOnClose="true" AutoSize="false" Top="0"  Height="680" Width="1024" Modal="true"  Left="0"  VisibleStatusbar="false"  ></telerik:RadWindowManager>      
          </div>
