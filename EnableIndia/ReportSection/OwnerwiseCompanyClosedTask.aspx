<%@ Page Title="Owner wise Company Closed Tasks" Language="C#" MasterPageFile="~/Candidate/Candidate.master" AutoEventWireup="true" Inherits="EnableIndia.ReportSection.OwnerwiseCompanyClosedTask" Codebehind="OwnerwiseCompanyClosedTask.aspx.cs" %>
...
<table cellpadding="0" cellspacing="0">
    ...
    <table cellpadding="0" cellspacing="0"  class="pageHeaderLevel1">
        <tr>
            <td>Ownerwise Closed Company Work Distribution</td>
        </tr>
    </table>
</asp:Content>
