...
{
    public partial class OwnerWiseOpenCandidateTask : System.Web.UI.Page
    {
        ...
        protected void BtnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            report.RegData("DsOwnerWiseWorkDistribution", cand.GetOwnerwiseOpenCandidateTask(cand));

            report.Load(Server.MapPath("~/Reports/OpenCandidatesOwnerWiseWorkDistribution.mrt"));
