...
{
    public partial class OwnerwiseCompanyClosedTask : System.Web.UI.Page
    {
        ...
        protected void BtnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            report.RegData("DsOwnerwiseCompanyClosedTasks", comp.GetOwnerwiseClosedCompanyTask(comp));

            report.Load(Server.MapPath("~/Reports/OwnerwiseCompanyClosedTasks.mrt"));
